...
class Course:
    ...
    def generate_course_figure1(self):
        ...
        plt.title("Top 10 Subcategories Having Most Number of Subscribers", pad=20)
    ...
    def generate_course_figure2(self):
        ...
        for index, value in enumerate(ys):
            plt.text(index, value, str(value), ha="center", va="bottom")
        plt.rcParams.update({'font.size': 12})
        plt.title("Top 10 Courses With Lowest Avg. Rating Having More Than 50000 Reviews", pad=20)
    ...
    def generate_course_figure3(self):
        ...
        for index, value in enumerate(ys):
            plt.text(index, value, str(value), ha="center", va="bottom")
        plt.rcParams.update({'font.size': 12})
        plt.title("Distribution of Avg. Rating of Courses Having 10,000 to 100,000 Subscribers", pad=20)
    ...
    def generate_course_figure4(self):
        ...
        patches, texts = plt.pie(ys, explode=explode_list, labels=ys)
        plt.legend(patches, labels, bbox_to_anchor=(1.05, 1), loc="upper left", title="Category", borderaxespad=0)
        plt.tight_layout()
        plt.axis("equal")
        plt.rcParams.update({'font.size': 12})
        plt.title("Distribution of Courses by Category", pad=20)
        # plt.show()
    ...
    def generate_course_figure5(self):
        ...
        for index, value in enumerate(ys):
            plt.text(index, value, str(value), ha="center", va="bottom")
        plt.rcParams.update({'font.size': 12})
        plt.title("Number of Courses With and Without Reviews", pad=20)
