...
def show_menu(role):
    print("Please enter", role, "command for further service:")
            ...
            if type(user_object).__name__ == 'Admin':
                ...
                if input_string[0] == '1':
                    if len(input_string) == 1:
                        ...
                        print("No additional arguments allowed")
                    ...
                    print("Invalid command! Choose between 1-5")
            else:
